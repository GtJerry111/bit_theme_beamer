...
\usetheme[
	...
	Background=SCU-Lite, % SCU-Full ⚙️ | SCU-Lite | Custom | none → 背景显示设置
]{scu}
...
\institute{%
	...
	\mailscu{lr.wu.interact@outlook.com}
}
\date{\today}
...
\begin{frame}{Info.}
	...
	\faGithub\enspace{\color{scublue}\url{https://github.com/FvNCCR228/SCU-Beamer-Theme}}
